...
public class Mod5 extends AppCompatActivity {
    ...
    private Button b1, b2, b3, b4, b5, next, b9, b0, temizleB, eksiB, noktaB, b6, b7, b8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sonuc = findViewById(R.id.textView3);   noktaB = findViewById(R.id.buttonNokta);
      ...
      noktaB.setOnClickListener(new View.OnClickListener() {
          @Override
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                double sayi = Double.parseDouble(df.format(num1-num2));
                if (sonuc.getText().equals(Double.toString(sayi))) {
                    dogru2++;
    ...
    public void baslat() {
        ...
        num1 = 0.01 * myRandom.nextInt(99);
        num2 = 0.01 * myRandom.nextInt(99);
