...
public class MainActivity extends AppCompatActivity {
    ...
    // mod 1: max iki basamaklı toplama

    private Button b1, b2, b3, b4, b5, next, b9, b0, temizleB, b6, b7, b8, basla;
    ...
    // oyun sonu gelecek mesajda doğru sayısı 10dan azsa sen biraz cahilsin galiba mesela mathman ikonuyla
    // 10 dan büüyükse fena değil
    // 20 üstüyse bir mesaj daha
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // noktaB = findViewById(R.id.buttonNokta);
        temizleB = findViewById(R.id.temizleButon);

        // BİR DE PROGRESS BAR EKLEDİK Mİ TAMAMDIR
        // 3 FARKLI IMAGE VIEW GORUNSUN PUANA GORE VISIBLE OLURLAR

       /* new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(MainActivity.this,ModMenu.class));
               // finish(); BU NE İŞE YARIYOR FARK NE
                Intent sayfaGecisi = new Intent(getApplicationContext(), ModMenu.class);
