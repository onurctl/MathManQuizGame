...
public class Mod3 extends AppCompatActivity {
    ...
    // mod 3: ikiye bir çarpma

    // BURADAN YOLLA DB YE DOGRU YANLIS SAYISINI VS BASKA ACTIVITYE AKTARINCA SORUN CIKIYOR

    // NUMPAD DEĞİŞMELİ, SAĞ TARAFA  123 456 789 0-. OLSUN 3ERLİ, SOLDA İSE ALT ALTA BUYUK CEVAPLA TEMİZLE, CEVAPLA ALTTA

    private Button b1, b2, b3, b4, b5, next, b9, b0, temizleB, b6, b7, b8;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                startActivity(new Intent(Mod3.this,ModMenu.class));
                finish();
